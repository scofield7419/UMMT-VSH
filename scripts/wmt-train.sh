# usage: bash multi30k-wmt-train.sh [-s src] [-t tgt] [-a arch] [-b tokens] [-q vis_tokens] [-n batch_size] [-l learning_rate]
...
python train.py ${data_dir} --utils vislang_halluc_translation \
