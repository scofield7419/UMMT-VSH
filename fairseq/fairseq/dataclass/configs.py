...
class FairseqDataclass:
    """fairseq base utils that supported fetching attributes and metas"""
...
class CommonConfig(FairseqDataclass):
    # This is the core utils including common parameters shared by all different jobs. Please append your params to other dataclasses if they were
