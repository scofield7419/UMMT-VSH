...
class TransformerConfig(FairseqDataclass):
    ...
    # We need to make this hierarchical utils like the flat namespace
    ...
    def from_namespace(cls, args):
        ...
        if not isinstance(args, cls):
            ...
            # we got all the fields defined in the utils, but
            # the argparse namespace might have extra args for two reasons:
            #   - we are in a legacy class so all the args are not declared in the utils. Ideally once everyone has defined a utils for their model, we won't need this
